					...
					<form action="ModificarProducto" method="POST">
						<tr>
							...
							<td><input type="text" name="nombre_producto"
								value="${listaTemp.getProducto().getNombreProducto()}"></td>
							<td><input type="number" name="precio_producto"
								value="${listaTemp.getProducto().getPrecioProducto()}"></td>
							<td><input type="text" name="descripcion_producto"
								value="${listaTemp.getProducto().getDescripcionProducto()}"></td>
							<td><label for="categoria" class="form-label">${listaTemp.getCategoria().getNombrCategoria()}</label>
